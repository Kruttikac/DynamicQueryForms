...
public class HomePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Dynamic query Forms");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ResultSet rs=st.executeQuery("select * from register where UserName='"+uname+"' and Password='"+pwd+"'");
            if(rs.next())
            { 
                String name=rs.getString(3);
                
                JOptionPane.showMessageDialog(new JFrame(),"Login Successfully!");
                UserFrame uf=new UserFrame(name);
                uf.setVisible(true);
            ...
            {
                JOptionPane.showMessageDialog(new JFrame(),"Username & Password is Invalid!");
            }
        }
        catch(Exception e)
        {
